...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("startdatalog.log", mode='a'),
    ]
)
logging.info('logged')
import time
...
import time
print("timeset")
logging.info('timereg')
print("RUNTIME",current_time.tm_hour,":",current_time.tm_min,":",current_time.tm_sec)
print("cmd-1.1.4")
time.sleep(0.4)
print("debug.s")
os.system('cls')
print("importing 10 package{/cal/calendar/supprocess/time/sys/loging/os/afd/}")
